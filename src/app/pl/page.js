        ...
        <div className="bg-white rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.08)] p-6 md:p-10">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-gray-50 rounded-2xl p-2 shadow-sm">
              ...
              <button  onClick={() => window.location.href = "https://h0mlr.ttrk.io/click"} className="mt-5 w-full py-3 rounded-xl bg-green-500 hover:bg-green-600 text-white text-base shadow-md">
                Check My Options →
              </button>
          ...
          <div className="mt-4 bg-gradient-to-br from-green-50 to-white rounded-2xl p-6 md:p-8">
            ...
            {/* FINAL CTA */}
            <button  onClick={() => window.location.href = "https://h0mlr.ttrk.io/click"} className="w-full py-3 rounded-xl bg-green-500 hover:bg-green-600 text-white text-base shadow-md">
              Check My Options →
            </button>
