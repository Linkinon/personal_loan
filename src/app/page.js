    ...
    <div className="text-gray-900 min-h-screen font-sans">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="bg-white rounded-2xl">
          ...
          {/* Sub Text */}
          <p className="text-justify text-sm sm:text-[17px] text-gray-600 max-w-5xl mx-auto mb-4 px-2">
          ...
          <a
            ...
            className="block w-full sm:max-w-5xl mx-auto my-4 bg-red-600 hover:bg-red-700 text-white text-center py-3 sm:py-4 text-base sm:text-lg font-semibold rounded-lg transition"
          >
            Available Offers →
          </a>
          ...
          <div className="p-4 sm:p-6">
            ...
            <ul className="max-w-5xl mx-auto text-md sm:text-md list-disc pl-5 space-y-2">
            ...
            <p className="text-md sm:text-md text-gray-500 mt-3 max-w-5xl mx-auto">
          ...
          <div className="p-4 sm:p-6">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-3 text-sm sm:text-sm text-red-900 mt-4 max-w-5xl mx-auto">
        ...
        <footer className="mt-6 text-xs sm:text-sm text-gray-600 text-center space-y-3 px-2">
          <div className="flex flex-wrap justify-center gap-2">
            ...
            <span>|</span>
            <Link href="/contact" className="underline text-gray-900">Contact</Link>
          </div>
