    ...
    <div className="text-gray-900 min-h-screen font-sans">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="bg-white rounded-2xl">
          ...
          {/* Heading */}
          <h1 className="text-center text-lg sm:text-4xl font-semibold my-5 px-2">
          ...
          <a
            ...
            className="block w-full sm:max-w-4xl mx-auto my-4 bg-red-600 hover:bg-red-700 text-white text-center py-3 sm:py-4 text-base sm:text-lg font-extrabold rounded-lg transition"
          >
            Available Offers →
          </a>
          ...
          <div className="p-4 sm:p-6">
            ...
            <ul className="max-w-4xl mx-auto text-sm sm:text-md list-disc pl-5 space-y-2">
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-3 max-w-4xl mx-auto">
          ...
          <div className="p-4 sm:p-6">
            ...
            <div className="space-y-2 text-sm sm:text-md">
