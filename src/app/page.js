  ...
  return (
    <div className="text-gray-900 min-h-screen font-sans">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3">
        ...
        {/* Top Note */}
        <div className="text-center text-[7px] md:text-[10px]  text-red-700  mb-2">
        ...
        <div className="bg-white rounded-2xl">
          ...
          <div className="p-4 sm:p-6">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg pl-4 py-2 text-[10px]  text-red-900 mt-4 max-w-4xl mx-auto">
        ...
        {/* Footer */}
        <footer className=" text-xs sm:text-sm text-gray-600 text-center space-y-4 px-2">
